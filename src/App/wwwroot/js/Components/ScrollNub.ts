...
function checkScroll(): void {
    ...
    const minTopPosition = (<HTMLElement>document.querySelector('top-menu')).offsetHeight;
    const maxBottomPosition = (<HTMLElement>document.querySelector('body > #scrollBottom')).offsetTop -
